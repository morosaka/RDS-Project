...
open class SessionMesg : Mesg {
    ...
    public static let metabolicCaloriesFieldNum:UInt8 = 196
	...
	public func setLeftRightBalance(_ value: LeftRightBalance100) throws {
		try setFieldValue(fieldNum: SessionMesg.leftRightBalanceFieldNum, value: value)
	}
	...
	public func getMetabolicCalories() -> UInt16? {
		guard let value = getFieldValue(fieldNum: SessionMesg.metabolicCaloriesFieldNum, index:0) as? UInt16 else {
            return nil
        }
		return value
	}

	public func setMetabolicCalories(_ value: UInt16) throws {
		try setFieldValue(fieldNum: SessionMesg.metabolicCaloriesFieldNum, value: value)
	}
	...
	public class func createSessionMesg() -> SessionMesg {
		...
		mesg.fields[SessionMesg.metabolicCaloriesFieldNum] = Field(name: "MetabolicCalories", num: SessionMesg.metabolicCaloriesFieldNum, type: BaseType.UINT16.rawValue, scale: 1, offset: 0, units: "kcal", accumulated: false)
